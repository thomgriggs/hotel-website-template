...
// Quick script to create default pages
// This will prompt for Sanity token if not set
...
async function getSanityToken() {
  ...
  if (!token) {
    console.log('🔑 Sanity token not found in environment variables.');
    console.log('');
    ...
    token = await askQuestion('Enter your Sanity token: ');
  }
